      ...
      <div className="py-[75px] container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-center mt-10 bg-[url('/assets/industry-bg.png')] bg-cover p-10">
          <div className="flex flex-col items-center">
            <Image src={'/assets/ind-2.png'} width={108} height={238} className="w-auto h-28 object-cover" alt="icon"/>
            <p className="text-2xl text-white mt-5">Banking & Finance</p>
          </div>
          <div className="flex flex-col items-center">
            <Image src={'/assets/ind-1.png'} width={108} height={238} className="w-auto h-28 object-cover" alt="icon"/>
            <p className="text-2xl text-white mt-5">Sports Analytics</p>
          </div>
          <div className="flex flex-col items-center">
            <Image src={'/assets/ind-3.png'} width={108} height={238} className="w-auto h-28 object-cover" alt="icon"/>
            <p className="text-2xl text-white mt-5">Automotive</p>
          </div>
          <div className="flex flex-col items-center">
            <Image src={'/assets/ind-4.png'} width={108} height={238} className="w-auto h-28 object-cover" alt="icon"/>
