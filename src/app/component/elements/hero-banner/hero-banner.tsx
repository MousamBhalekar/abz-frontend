      ...
      <div className="grid grid-cols-5 gap-4 h-[93vh] items-center py-10">
        <div className="col-span-2 ">
          <div className="w-[460px] ">
            <h1 className="text-[60px] leading-[70px]  text-[#fff] ">{title}</h1>
            <p className="mt-2 text-lg  text-[#fff]">{description}</p>
            <Button variant="outline" className="justify-between mt-6" icon={<Icons.ArrowRightTop  className="text-white" />}>
               {btnText}
            </Button>                 
          </div>
